...
]).value('duScrollDuration', 350).value('duScrollGreedy', false).value('duScrollEasing', duScrollDefaultEasing).value('duScrollOffset', 0);
...
angular.module('duScroll.spyAPI', ['duScroll.scrollContainerAPI']).factory('spyAPI', [
  ...
  'duScrollGreedy',
  'duScrollOffset',
  function ($rootScope, scrollContainerAPI, duScrollGreedy,duScrollOffset) {
    var createScrollHandler = function (context) {
      return function () {
        var container = context.container, containerEl = container[0], containerOffset = duScrollOffset;
    ...
    return {
      link: function ($scope, $element, $attr) {
        $element.on('click', function (e) {
          ...
          container.scrollToElement(angular.element(target), isNaN(offset) ? 0 : duScrollOffset, isNaN(duration) ? 0 : duration);
        });
      }
    };
  }
